...
import { ArrowLeft, Check, Loader2, Phone, MapPin, Building, Mail, Globe, Truck, Plus, X, Save, Edit2, Search } from 'lucide-react';
...
export default function AddTransportador() {
  ...
  const loadAllData = async () => {
    try {
      ...
      const [cidadesData, estadosData, paisesData] = await Promise.all([
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="flex items-center gap-2 mt-8">
                  <input type="checkbox" id="ativo" name="ativo" checked={formData.ativo} onChange={handleChange} className="w-4 h-4 text-black focus:ring-black border-gray-300 rounded cursor-pointer" />
                  <label htmlFor="ativo" className="text-sm font-medium text-gray-700 cursor-pointer">Ativo</label>
                </div>
              </div>
            </div>
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    <select name="codCidade" value={formData.codCidade} onChange={handleChange}
                      ...
                      className={`${selectClass} flex-1 pr-10 ${loadingOptions ? 'opacity-60 cursor-not-allowed' : ''}`}>
