...
export default function AddCliente() {
  ...
  const [formData, setFormData] = useState({
    cliente: '', rg_inscEst: '', tipoPessoa: '', cpf_cnpj: '',
    ender: '', numero: '', complemento: '', bairro: '', cep: '',
    codCidade: '', site: '', fone: '', email: '', codCondPagamento: '',
    limiteCredito: ''
  });
    ...
    <AnimatedPage>
      <div className="min-h-screen bg-[#fafafa] pt-24 pb-12 px-8 text-gray-800 font-sans">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-light text-gray-900 tracking-tight">Novo Cliente</h1>
            <p className="text-sm text-gray-500 mt-1">Preencha os dados do novo cliente.</p>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input name="rg_inscEst" value={formData.rg_inscEst} onChange={handleChange} placeholder="Ex: 12.345.678-9" className={inputClass} />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input name="numero" value={formData.numero} onChange={handleChange} placeholder="123" className={inputClass} maxLength={10} />
                </div>
                <div className="flex flex-col gap-2">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input required type="number" step="0.01" min="0" name="limiteCredito" value={formData.limiteCredito} onChange={handleChange} placeholder="0.00" className={inputClass} />
                </div>
              </div>
            </div>

            <div className="flex gap-4">
              <Link to="/Clientes" className="px-6 py-3 border border-gray-200 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors text-center">Cancelar</Link>
              <button type="submit" disabled={isSubmitting} className="cursor-pointer flex-1 px-6 py-3 bg-black text-white rounded-xl text-sm font-medium hover:bg-gray-900 transition-colors disabled:opacity-70 flex justify-center items-center gap-2">
                {isSubmitting ? <Loader2 size={16} className="animate-spin" /> : <Check size={16} />} {isSubmitting ? 'Salvando...' : 'Cadastrar Cliente'}
              </button>
            </div>
          </form>
        </div>
