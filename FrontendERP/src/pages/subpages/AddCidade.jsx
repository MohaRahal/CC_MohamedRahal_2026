...
export default function AddCidade() {
  ...
  // Handlers para o Form Principal
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center p-6 border-b border-gray-100">
              <h2 className="text-xl font-medium text-gray-900">Novo Estado</h2>
              <button onClick={() => setIsEstadoModalOpen(false)} className="text-gray-400 hover:text-gray-600 transition-colors">
                <X size={20} />
              </button>
            </div>
            <form onSubmit={handleEstadoSubmit} className="p-6 flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <label className="text-sm font-medium text-gray-700">Nome do Estado <span className="text-red-500">*</span></label>
                <input 
                  name="estado" value={estadoData.estado} onChange={handleEstadoChange} required placeholder="Ex: São Paulo"
                  className="w-full px-4 py-2.5 bg-[#fafafa] border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-black focus:border-black transition-all"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <input 
                  name="UF" value={estadoData.UF} onChange={handleEstadoChange} required maxLength={2} placeholder="Ex: SP"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <select 
                    name="codPais" value={estadoData.codPais} onChange={handleEstadoChange}
                    className="flex-1 px-4 py-2.5 bg-[#fafafa] border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-black focus:border-black transition-all"
                  >
