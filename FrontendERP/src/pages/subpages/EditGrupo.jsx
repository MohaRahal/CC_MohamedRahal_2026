...
export default function EditGrupo() {
    ...
    if (id) {
      gruposService.getGrupoById(id)
        ...
        .catch(error => {
          ...
          alert("Não foi possível carregar os dados deste grupo.");
        })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await gruposService.updateGrupo(id, {
        ...formData,
        codGrupo: Number(id),
      });
      navigate('/Grupos');
    ...
    <AnimatedPage>
      <div className="min-h-screen bg-[#fafafa] pt-24 pb-12 px-8 text-gray-800 font-sans">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-light text-gray-900 tracking-tight">Editar Grupo</h1>
            <p className="text-sm text-gray-500 mt-1">Atualize os dados deste grupo.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 flex flex-col gap-6">
            <div className="grid grid-cols-1 gap-6">
              <div className="flex flex-col gap-2">
                ...
                <input
                  name="grupo" required value={formData.grupo} onChange={handleChange}
